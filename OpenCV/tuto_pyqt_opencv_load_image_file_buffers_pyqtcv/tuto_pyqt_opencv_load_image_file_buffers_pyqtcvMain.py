...
from tuto_pyqt_opencv_load_image_file_buffers_pyqtcv import *
...
# la classe reçoit le Qwidget principal ET la classe Ui_Form définie dans *.py obtenu avec pyuic4
	...
	def __init__(self, parent=None):
		...
		# cette fonction pyqtcv cree plusieurs "buffers" image utiles pour les traitements courants
	...
	def pushButtonOuvrirClicked(self):
		...
		# traitement image
		#====> placer ici les fonctions de traitement de l'image <======
