...
#
# Created: Tue Oct 15 16:11:08 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButtonOuvrir.setGeometry(QtCore.QRect(595, 280, 51, 21))
        self.pushButtonOuvrir.setObjectName(_fromUtf8("pushButtonOuvrir"))
        self.lineEditChemin = QtGui.QLineEdit(Form)
        self.lineEditChemin.setGeometry(QtCore.QRect(0, 280, 591, 23))
        ...
        self.radioButtonHorizontal = QtGui.QRadioButton(Form)
        self.radioButtonHorizontal.setGeometry(QtCore.QRect(330, 250, 126, 20))
        self.radioButtonHorizontal.setAutoExclusive(False)
        self.radioButtonHorizontal.setObjectName(_fromUtf8("radioButtonHorizontal"))
        self.radioButtonVertical = QtGui.QRadioButton(Form)
        self.radioButtonVertical.setGeometry(QtCore.QRect(475, 250, 116, 20))
        self.radioButtonVertical.setAutoExclusive(False)
        self.radioButtonVertical.setObjectName(_fromUtf8("radioButtonVertical"))
    ...
    def retranslateUi(self, Form):
        ...
        self.radioButtonHorizontal.setText(QtGui.QApplication.translate("Form", "Miroir Horizontal", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButtonVertical.setText(QtGui.QApplication.translate("Form", "Miroir Vertical", None, QtGui.QApplication.UnicodeUTF8))
